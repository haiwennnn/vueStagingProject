<template>
  <div>
    ...
    <div class="zz-toast" v-show="show" :class="toastClass">
      <i class="zz-toast-icon zz-toast-loading iconfont icon-loading" v-if="type === 'loading'"></i>
      <i class="icon iconfont icon-done zz-toast-icon zz-toast-done" v-if="type === 'done'"></i>
