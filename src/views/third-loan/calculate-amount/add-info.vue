...
<script>
  ...
  import Idata from '@/assets/icons/data.png'
  // import Izhima from '@/assets/images/offline/icons/zhima.png'
  // import Igjj from '@/assets/images/offline/icons/gjj.jpg'
  // import Isheb from '@/assets/images/offline/icons/sheb.jpg'
  // import Izx from '@/assets/images/offline/icons/zx.png'
  // import Guar from '@/assets/images/offline/icons/guarantee.png'
  export default {
    data() {
      return {
        // 是否获取到当前的查询状态
